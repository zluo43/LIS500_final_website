...
<?php
   ...
   $question_text = "The government allows chronic poverty to continue, and as a system, should
   invest more into people and their communities.";
?>
<body>
<form method ="post" action="pageeleven.php">
