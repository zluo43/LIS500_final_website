...
<head>
    <meta charset="UTF-8">
    <title>How Classist Are You? Survey</title>
...
<?php
   ...
   $question_text = "I find myself to be sometimes guilty of classism, despite my own poverty.";
?>
<body>
<form method ="post" action="pagenine.php">
