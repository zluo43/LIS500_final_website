...
<?php
   ...
   $question_text = 'Social services, community services, or charities designed to "help the
   poor" are generally well-run and useful programs.';
?>
<body>
<form method ="post" action="pagefive.php">
