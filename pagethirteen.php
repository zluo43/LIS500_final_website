...
<?php
   ...
   $question_text = "The social class of my parents and/or my upbringing influenced my
   success in school and my professional aspirations.";
?>
<body>
<form method ="post" action="pagefourteen.php">
